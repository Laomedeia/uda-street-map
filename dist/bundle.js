...
/******/ 	var hotCurrentHash = "6eea49ff6c06bbd3437b"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_app_css__ = __webpack_require__(7);
...
const searchPoi = function (ko, vm) {
    ...
    AMap.service(["AMap.PlaceSearch"], function () {
        var placeSearch = new AMap.PlaceSearch({ //构造地点查询类
            ...
            pageIndex: 1,
            city: "020", //城市
            map: __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */]
        });
        //关键字查询
        placeSearch.search("", function (status, result) {
            console.log(__WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].getZoom());
            __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].setZoom(11);
            if (result && result.poiList && result.poiList.pois) {
                // 获取地图上所有marker对象
                let allMarkers = __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].getAllOverlays("marker");
...
let ViewModel = function (searchInput, poiArray) {
    ...
    this.searchEvent = function () {
        __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].clearMap();
        ...
        // }
        // console.log(keywordMarkerArray);
        __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].add(keywordMarkerArray);
        __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].setFitView();
        closeDrawer();
    };
    // Poi列表点击事件
    this.navItemClick = function (el) {
        ...
        let markerId = el.id;
        let mymarker = markerObj[markerId];
        console.log(__WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */]);
        __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].add(mymarker);
        __WEBPACK_IMPORTED_MODULE_1__js_mymap_js__["a" /* default */].setFitView();
        closeDrawer();
    };
    // 输入搜索字符串keyPress事件
    this.searchPress = function () {
        ...
        let filterArray = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.filter(poiArray, function (marker) {
            if (!marker.name) {
                return;
            }
