...
/******/ 	var hotCurrentHash = "df828de00cfa7307dbcd"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_app_css__ = __webpack_require__(34);
...
const searchPoi = function (ko, vm) {
    ...
    AMap.service(["AMap.PlaceSearch"], function () {
        var placeSearch = new AMap.PlaceSearch({ //构造地点查询类
            ...
            pageIndex: 1,
            city: "020", //城市
            map: __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */]
        });
        //关键字查询
        placeSearch.search("", function (status, result) {
            __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].setZoom(11);
            if (result && result.poiList && result.poiList.pois) {
                // 获取地图上所有marker对象
                let allMarkers = __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].getAllOverlays("marker");
                for (const poi of result.poiList.pois) {
                    ...
                    for (const marker of allMarkers) {
                        ...
                        if (markerId === marker.Xf) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(map_weather_url, {
                                params: {
                                    key: map_s_key,
                                    city: adcode,
                                    extensions: "base",
...
let markerClick = function (e) {
    ...
    infoWindow.open(__WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */], e.target.getPosition());
};
...
let ViewModel = function (searchInput, poiArray) {
    this.searchTxt = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observable(searchInput);
    this.markers = __WEBPACK_IMPORTED_MODULE_0_knockout___default.a.observableArray(poiArray);
    // 搜索按钮点击事件
    this.searchEvent = function () {
        __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].clearMap();
        ...
        __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].add(keywordMarkerArray);
        __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].setFitView();
        closeDrawer();
    };
    // Poi列表点击事件
    this.navItemClick = function (el) {
        ...
        let markerId = el.id;
        let mymarker = markerObj[markerId];
        __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].add(mymarker);
        __WEBPACK_IMPORTED_MODULE_2__js_mymap_js__["a" /* default */].setFitView();
        closeDrawer();
    };
    // 输入搜索字符串keyPress事件
    this.searchPress = function () {
        ...
        let filterArray = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.filter(poiArray, function (marker) {
            if (!marker.name) {
                return;
            }
...
//初始化查询所有兴趣点
searchPoi(__WEBPACK_IMPORTED_MODULE_0_knockout___default.a, new ViewModel("", poiArray));
  ...
  (function (n) {
    var A = this || (0, eval)("this"),
       ...
       true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__], __WEBPACK_AMD_DEFINE_FACTORY__ = (n),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" === typeof exports && "object" === typeof module ? n(module.exports || exports) : n(A.ko = {});
    })(function (P, Q) {
      function K(a, c) {
...
/* harmony default export */ __webpack_exports__["a"] = (mymap);
